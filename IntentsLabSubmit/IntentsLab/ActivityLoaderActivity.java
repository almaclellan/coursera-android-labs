...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation(View v) {
        
		Log.i(TAG,"Entered startExplicitActivation()");
		
		// TODO - Create a new intent to launch the ExplicitlyLoadedActivity class
		Intent explicitIntent = null;
		explicitIntent = new Intent(v.getContext(), ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation(View v) {
        ...
        chooserIntent = Intent.createChooser(new Intent(baseIntent), "Choose browser");
