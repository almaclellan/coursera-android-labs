...
public class BookmarksActivity extends Activity {
	...
	private void startGoToDangerousActivity(View v) {

		Log.i(TAG, "Entered startGoToDangerousActivity()");

		// TODO - Start the GoToDangerousActivity
		Intent dangerIntent = null;
		dangerIntent = new Intent(v.getContext(), GoToDangerousActivity.class);
		dangerIntent.setAction("course.labs.permissions.DANGEROUS_ACTIVITY");
		dangerIntent.addCategory("android.intent.category.DEFAULT");
